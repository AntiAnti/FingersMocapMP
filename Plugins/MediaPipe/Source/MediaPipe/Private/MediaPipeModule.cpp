...
void FixDeadlock()
{
	...
	const char* Variants[] = {		
		...
		// 5.2.0
		"48 89 5C 24 08 55 56 57 41 54 41 55 41 56 41 57 48 8D 6C 24 D9 48 81 EC C0 00 00 00 48 8B 05 F5 0A B3 00", // dev editor (unrealeditor-core.dll)
	#elif ENGINE_PATCH_VERSION == 1
		// 5.2.1
		"48 89 5C 24 08 55 56 57 41 54 41 55 41 56 41 57 48 8D 6C 24 D9 48 81 EC C0 00 00 00 48 8B 05 55 0B B3 00", // dev editor (unrealeditor-core.dll)
	#endif
